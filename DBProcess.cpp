...
*    Purpose:                                                       *
********************************************************************/
bool CDBProcess::openRecordsetBySql(const QString strSql, int idx /* = -1 */)
{
    if (false == isOpen())
    {
        return false;
...
void CDBProcess::closeRecordset(int idx /* = -1 */)
{
...
bool CDBProcess::recEOF(int idx /*= -1*/) const
{
    QSqlQuery *pQry = m_mapQry.value(idx);
    if(0 == pQry)
        return true;
...
bool CDBProcess::recBOF(int idx /*= -1*/) const
{
    QSqlQuery *pQry = m_mapQry.value(idx);
    if(0 == pQry)
        return true;
...
bool CDBProcess::moveFirst(int idx /* = -1 */) const
{
    if (false == isOpen())
    {
        return false;
...
bool CDBProcess::movePrevious(int idx /* = -1 */) const
{
    if (false == isOpen())
    {
        return false;
...
bool CDBProcess::moveNext(int idx /* = -1*/) const
{
    if (false == isOpen())
    {
        return false;
...
bool CDBProcess::moveLast(int idx /* = -1 */) const
{
    if (false == isOpen())
    {
        return false;
...
bool CDBProcess::moveTo(int n, int idx /* = -1 */) const
{
    if (false == isOpen())
    {
        return false;
...
long CDBProcess::getRecordCount(int idx /* = -1 */) const
{
    if (false == isOpen())
    {
        return -1;
...
bool CDBProcess::getFieldsValueFromRec(int idx, const char* szFldInfo, ...) const
{
    if (0 == szFldInfo)
    {
       return false;
...
bool CDBProcess::addFieldsValueToTbl(const QString strTbl, const char* szFldInfo, ...)
{
...
bool CDBProcess::updateTblFieldsValue(const QString strTbl, QString strWhere, const char * szFldInfo, ... )
{
    QSqlQuery * pQry = new QSqlQuery(*m_pDB);
